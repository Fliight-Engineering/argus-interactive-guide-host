...
The Access points create a dynamic mesh network which will autoconfigure on setup. 
...
<div class="antenna-images-container">
  <div class="antenna-image-wrapper">
    ![Repeater AP Antenna Configurations](/img/vts-guide/antennas-up.png)
    *Both antennas up for max direct range down a long drive run*
  </div>
  <div class="antenna-image-wrapper">
...
To plan training with the VTS, the map diagram below shows an example of a level setup where: 

- **Trainer position** situated out of the way of travel of the loader and other vehicles
